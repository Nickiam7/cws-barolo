      ...
      <form method='post' class='register'
         ...
         if ( $is_field_exists ) {
            ?>
               ...
               ?>
               <div class="ur-button-container px-1 <?php echo esc_html( implode( ' ', $btn_container_class ) ); ?>" >
                  <?php
                  ...
                  <button type="submit" class="btn cws-btn-primary btn-block mx-0 ur-submit-button <?php echo esc_html( implode( ' ', $submit_btn_class ) ); ?>">
                     <span></span>
